...
const Hero = () => {
    ...
    const iconLinks = [
        ...
        { icon: <FaUserGraduate />, link: "#education", label: "Education & Work Experience" },
            ...
            <div className="bg-[#140C1C] border border-[#3d2456] rounded-3xl md:p-10 p-4 pb-10 flex flex-col md:flex-row items-center gap-10 max-w-6xl w-full shadow-xl">
                ...
                <div>
                    <h1 className="font-sora text-[36px] leading-[46px] md:text-[56px] font-medium gradient-text md:leading-tight">
                        Hi, I am Muniyasamy – Web Developer
                    </h1>
                    <img
                        src={muni}
                        alt="Profile"
                    ...
                    <p className="font-sora font-light text-[16px] leading-[30px] text-[#DDDDDD] pt-6">
                        I’m a passionate WordPress and React developer with 2+ years of experience building responsive, user-friendly websites and applications. I specialize in Elementor, Divi, ACF, and plugin customization, with hands-on experience in React, Redux, and the MERN stack. My projects span diverse industries, from healthcare to solar energy, delivering fast, secure, and SEO-optimized web experiences.
                    </p>
