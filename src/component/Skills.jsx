...
const skills = [
    ...
    { icon: <SiWordpress size={50} color="#21759B" />, label: "WordPress", percent: "80%" },
    { icon: <SiExpress size={50} color="#ffffff" />, label: "Express JS", percent: "70%" },
    { icon: <SiMongodb size={50} color="#4DB33D" />, label: "MongoDB", percent: "70%" },
    { icon: <SiGithub size={50} color="#ffffff" />, label: "GitHub", percent: "80%" },
    { icon: <SiFirebase size={50} color="#FFCA28" />, label: "Firebase", percent: "80%" },
    {
        icon: <img src={awsLogo} alt="AWS" className="w-[50px] h-[50px] object-contain" />,
        label: "AWS",
        percent: "50%",
        isImage: true,
    },
